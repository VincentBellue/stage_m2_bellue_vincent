...
liste_nom_vecteur,liste_de_liste_vecteur = parcours_fichier(entree_utilisateur,reponse,False,False,False)#1er False=dendrogramme(et pas similarité);2ème False=vecteur contextuel; 3ème False=groupes de 20 exemples(variable onze_ex sur False)

#nom_fichier_out,labels_dendro,modele= utilisés pour les paramètres de la figure
nom_fichier_out,labels_dendro,modele=dendrogramme_output(liste_de_liste_vecteur,liste_nom_vecteur,reponse,False,False,entree_utilisateur,True)#1er False=vecteurs contextuels,2ème False=groupes de 20 exemples,True=on crée un dendrogramme
