...
def main():
	...
	for ligne in tableau:
		...
		output.write(str(numero_ligne_phrase) + "\t" + trait_compositionnel + "\t" + tok_lu_un + "\t" + " ".join(map(str, vecteur_tok_un.numpy()))+ "\t" + tok_lu_deux + "\t" + " ".join(map(str, vecteur_tok_deux.numpy())) + "\t" + phrase + "\n")
		cpt+=1
